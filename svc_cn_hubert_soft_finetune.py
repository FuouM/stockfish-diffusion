...
from audio_stuff.audio_folder import AudioFolderDataset

_base_ = [
    "./model/_base_/archs/diff_svc_v2.py",
    "./model/_base_/trainers/base.py",
    "./model/_base_/schedulers/warmup_cosine_finetune.py",
    "./model/_base_/datasets/audio_folder.py",
]
