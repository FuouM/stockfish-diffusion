...
from whisper_stuff import _MODELS, log_mel_spectrogram, pad_or_trim
from whisper_stuff.model import AudioEncoder, LayerNorm, ResidualAttentionBlock, sinusoids
